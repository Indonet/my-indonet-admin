...
function createTransactionMid($dataUser){ 
    ...
    if($devmode) {    
        ...
        $return_url = "https://dev-myportal.indo.net.id/customer/account/order_check/".$inv_payment_id."/";
    }else{  
        $ckey = 'VT-client-r91vxohFBz_OmHM3'; 
        $notificationURL = "https://blesta.indonet.co.id/callback/gw/1/midtrans_snap/" . $clientId;
        $return_url = "https://myportal.indo.net.id/customer/account/order_check/".$inv_payment_id."/";
    } 
