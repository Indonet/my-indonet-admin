...
function view_list(){
    ...
    if(periode_view){
        ...
        $.ajax({
            url: base_url+"check-faktur-pajak-indonet",
            type: 'POST', 
            cache: false,
            dataType: "json",
...
function get_list(){  
    ...
    $('#list_faktur_pajak').DataTable( {       
        ajax:{
            "url":  base_url+"view-faktur-pajak-indonet",
            "type": "POST", 
            "data": {"periode":periode_view}
        },
        "columns": [   
...
$("form.upload_fp_indonet").submit(function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url+"upload-faktur-pajak-indonet",
                type: 'POST',
                ...
                success: function (res) { 
                    if(res.result){  
                        Swal.fire('','Upload file success','success').then((result) => {  
                            $('#modal_upload_fp_indonet').modal('toggle');
...
function view_billing(periode, billing_name){
    ...
    $.ajax({
        url: base_url+"view-billing-indonet-pdf",
        type: 'POST', 
        cache: false,
        dataType: "json",
...
function view_faktur(periode, faktur_name){
    ...
    $.ajax({
        url: base_url+"view-faktur-indonet-pdf",
        type: 'POST', 
        cache: false,
        dataType: "json",
...
function check_count(){
    var periode_view = $('#periode_view').val();
    $.ajax({
        url: base_url+"check-count-billing-faktur-indonet-pdf",
        type: 'POST', 
        cache: false,
        dataType: "json",
        data: {'periode':periode_view},
...
function send_all_email(periode_view){ 
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url+"send-all-billing-indonet",
                type: 'POST', 
                cache: false,
                dataType: "json",
...
function view_log_send_email_all(periode_view){
    ...
    $.ajax({
        url: base_url+"view-log-send-email-all-billing-indonet",
        type: 'POST', 
        cache: false,
        dataType: "json",
        data: {'periode_view':periode_view},
...
function send_email(periode_view, cust_id){
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url+"send-email-billing-indonet",
                type: 'POST', 
                cache: false,
                dataType: "json",
