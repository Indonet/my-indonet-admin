        ...
        <div class="card-toolbar">
            ...
            <div class="dropdown dropdown-inline mr-2">
                ...
                <span class="svg-icon svg-icon-md">
                    <!--begin::Svg Icon | path:<?=base_url()?>assets/themes/media/svg/icons/Design/PenAndRuller.svg-->
            ...
            <span class="svg-icon svg-icon-md">
                <!--begin::Svg Icon | path:<?=base_url()?>assets/themes/media/svg/icons/Design/Flatten.svg-->
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24" />
...
<script src="<?=base_url()?>assets/themes/js/pages/crud/datatables/basic/basic.js"></script>