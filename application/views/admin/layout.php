...
<html lang="en"> 
	<head> 
		...
		<meta charset="utf-8" />
		<title><?=$title?> | admin-my.indonet.id</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading <?=$menu_minize = isset($menu_minize) ? $menu_minize : "";?>">  
