...
<div class="container-fluid">
    <?php //print_r($data_cust); 
        ...
        // print_r($data_cust['BALANCE'][0]->BALANCEMST);
...
<script> 
    ...
    function get_inv_page(month = '', year ='', m_name = ''){ 
        ...
        $.ajax({
            ...
            data: { 
                'month':month, 'year':year, 'json_data_cust':json_data_cust, 'json_inv_month_total':json_inv_month_total, 'json_inv_month_details':json_inv_month_details
            },
            cache: false,
            dataType: "html",
