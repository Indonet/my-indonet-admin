        ...
        <div class="topbar">  
            <div class="dropdown"> 
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form> 
                        <div class="d-flex flex-column bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?=base_url()?>assets/themes/media/misc/bg-1.jpg)">
                         
                            <h4 class="d-flex flex-center rounded-top hide">
                        ...
                        <div class="tab-content"> 
                            <div class="tab-pane active show " id="topbar_notifications_notifications" role="tabpanel"> 
                                <div class="scroll pr-7 mr-n7 hide" data-scroll="true" data-height="300" data-mobile-height="200"> 
                            ...
                            <div class="tab-pane" id="topbar_notifications_events" role="tabpanel"> 
                                <div class="navi navi-hover scroll my-4 hide" data-scroll="true" data-height="300" data-mobile-height="200"> 
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <?php if(isset($data_cust[0]->NAME)){
                        $name = $data_cust[0]->NAME;
                    }else{
                        $name = 'None';
                    }
                    ?>
                    ...
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold"><?=substr($name, 0, 1)?></span>
                    </span>
                </div>
            </div> 
        </div> 
